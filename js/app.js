...
***************************************************************************** */
        ...
        $(document).ready((function() {
            var $curr, $list = $(".body-gallery__items-body .body-gallery__image").hide();
            $(".navigation__button").on("click", (function() {
                ...
                console.log($list);
            })).filter("._active").click();
            $("#LoadMore").on("click", (function() {
                $curr.filter(":hidden").slice(0, 50).slideDown("fast");
                console.log($curr);
            }));
            $("#LoadLess").on("click", (function() {
                $curr.slice(3).slideUp("fast");
                console.log($curr);
            }));
        }));
        window.addEventListener("load", (function(e) {
